...
* You will need a recent (0.6.9 or later) version of OpenSim.
...
* Create the folder structure addon-modules/SimianGrid/config in your OpenSim
  bin/ folder. Copy SimianGrid.ini into the newly created folder.
...
SimianGrid's logs/ files for errors.
